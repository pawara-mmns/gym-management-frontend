    ...
    <div className="h-screen flex overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#0f1419] px-8 py-6 overflow-y-auto">
        <div className="w-full max-w-md my-auto">
          ...
          <button className="w-full py-3 px-6 bg-transparent border border-gray-700 hover:bg-[#1a2332] text-white rounded-lg font-medium flex items-center justify-center gap-3 transition">
